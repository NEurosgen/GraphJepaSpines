...
def get_datamodule(cfg):
    ...
    mask_norm = MaskNorm(mean_x = mean_x, std_x = std_x, mean_edge=mean_edge, std_edge=std_edge, mask_ratio=cfg.mask_ratio) # mask ratio тоже в конфиг надо вынести
...
if __name__ == "__main__":
    ...
    PARAM_NAME = "network.encoder.alpha"
